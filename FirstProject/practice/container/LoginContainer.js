    ...
    render() {
        ...
        return (
            <View>
                ...
                <Button value="NORMAL FLAT" raised={true} text="Signup" onPress={() => navigate('Signup', { name: 'Signup' })} />
            </View>
        )
    }
    ...
    render(){
      return(
        <TouchableOpacity onPress={this.props.onLoginClicked} activeOpacity={0.2} focusedOpacity={0.5}>
           <View style=  {{alignItems:'center',justifyContent:'center',alignItems:'center',width:128,height:40,backgroundColor:'#841584'}}>
